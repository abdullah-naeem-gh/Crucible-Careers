                  ...
                  <tr key={job.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-5 py-4">
                      <div className="flex justify-end gap-2">
                        <Link href={`/employer/dashboard?tab=jobs#${job.id}`} className="px-3 py-1.5 rounded-md border border-gray-200 bg-white text-gray-700 hover:bg-gray-50">View details</Link>
                        <Link href={`/employer/dashboard/jobs/${job.id}/applicants`} className="px-3 py-1.5 rounded-md border border-gray-200 bg-white text-gray-700 hover:bg-gray-50">Applicants</Link>
                      </div>
                    </td>
                  </tr>
                ))}
