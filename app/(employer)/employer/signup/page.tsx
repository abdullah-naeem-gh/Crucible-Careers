    ...
    <main className="min-h-screen w-full relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-screen px-6">
        ...
        <nav className="relative z-20 flex items-center justify-between py-4">
          ...
          <Link
            href="/talent/signup"
            className="rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm font-medium text-white shadow-sm backdrop-blur transition-colors hover:border-[#FF6B00] hover:text-[#FF6B00]"
          >
            Talent Sign Up
          </Link>
        </nav>
