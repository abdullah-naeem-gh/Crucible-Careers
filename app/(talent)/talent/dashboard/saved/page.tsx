                ...
                <div className="border-b border-gray-100/50 bg-gray-50/50 p-4 grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full text-xs px-3 py-2 rounded-lg border border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-orange-200 focus:border-orange-400 cursor-pointer"
                    >
                      {companies.map(c => (
