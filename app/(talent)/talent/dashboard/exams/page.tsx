                ...
                <div className="flex-1 overflow-auto p-5 space-y-3.5">
                  {availableExams.map((exam, idx) => (
                    ...
                    >
                      ...
                      <button className="w-full py-2 rounded-xl bg-gradient-to-r from-[#FF6B00] to-[#FF914D] text-white text-xs font-semibold hover:opacity-95 shadow-sm transition-all text-center">
                        Take Exam
                      </button>
                    </motion.div>
                  ))}
