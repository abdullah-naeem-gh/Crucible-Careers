...
export default function TalentSidebar({ jobCount = 4, applicationCount = 12, savedCount = 5 }: TalentSidebarProps) {
  ...
  return (
    <aside className="col-span-3 bg-white/70 backdrop-blur-sm border border-gray-100 rounded-2xl p-6 flex flex-col shadow-lg self-center h-[92vh]">
      ...
      <div className="mt-auto rounded-xl p-4 bg-gradient-to-br from-[#FF6B00]/10 to-[#FF914D]/10 border border-orange-200">
        ...
        <Link href="/profile" className="inline-block text-xs px-3 py-2 rounded-lg bg-gradient-to-r from-[#FF6B00] to-[#FF914D] text-white">
          Update Profile
        </Link>
      </div>
    </aside>
