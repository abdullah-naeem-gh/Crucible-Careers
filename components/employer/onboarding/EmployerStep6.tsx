  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col items-center gap-5">
        ...
        >
          {data.logoDataUrl ? (
            ...
            <img src={data.logoDataUrl} alt="Logo preview" className="w-full h-full object-cover" />
          ) : (
      ...
      <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl border border-white/[0.08] bg-[#141414] flex items-center justify-center overflow-hidden shrink-0">
            {data.logoDataUrl ? (
              // eslint-disable-next-line @next/next/no-img-element
              <img src={data.logoDataUrl} alt="Preview" className="w-full h-full object-cover" />
            ) : (
      ...
      <ImageCropModal
        ...
        onApply={(dataUrl) => { onChange({ logoDataUrl: dataUrl }); setPending(null) }}
      />
    </div>
  )
}
