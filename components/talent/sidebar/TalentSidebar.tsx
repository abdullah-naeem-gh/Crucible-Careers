...
import { IconBriefcase, IconBuilding, IconFileDescription, IconBookmark, IconUser, IconAward, IconSettings, IconChevronLeft, IconChevronRight, IconLogout } from '@tabler/icons-react'

const TAB_ICONS: Record<string, React.ComponentType<any>> = { jobs: IconBriefcase, companies: IconBuilding, applications: IconFileDescription, saved: IconBookmark, profile: IconUser, exams: IconAward, settings: IconSettings }
...
export default function TalentSidebar({ activeTab, onTabChange, jobCount = 4, applicationCount = 12, savedCount = 5, profileNeedsSetup = false, profileCompletion = 0, profileFirstName, profileLastName, profileEmail, collapsed = false, onCollapsedChange }: TalentSidebarProps) {
